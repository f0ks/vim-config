...
elseif (&term == "builtin_gui")
    ...
    highlight MoreMsg		gui=bold		guifg=DarkGreen
    highlight Question		gui=bold		guifg=DarkGreen
    "
    ...
    " Group: type group {{{3
    "
    highlight StorageClass	gui=none		guifg=DarkGreen
    highlight Structure		gui=none		guifg=DarkSlateGray4
    highlight Type		gui=none		guifg=DarkGreen
...
elseif	(&term == "xterm")  ||
    ...
    highlight Title		term=bold				    ctermfg=Black	ctermbg=LightGray
